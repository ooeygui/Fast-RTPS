...
PublisherQos::PublisherQos()
{
    ...
    this->m_durability.kind = fastrtps::TRANSIENT_LOCAL_DURABILITY_QOS;
}
...
bool PublisherQos::checkQos() const
{
...
bool PublisherQos::canQosBeUpdated(const PublisherQos& qos) const
{
    using namespace fastrtps;
    bool updatable = true;
