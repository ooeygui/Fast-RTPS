...
private:
    ...
    std::map<eprosima::fastdds::DataReader*, eprosima::fastrtps::types::DynamicType_ptr> readers_;
    std::map<eprosima::fastdds::DataReader*, eprosima::fastrtps::types::DynamicData_ptr> datas_;
...
public:
    class SubListener
        : public eprosima::fastdds::DataReaderListener
        , public eprosima::fastdds::DomainParticipantListener
    {
    public:
